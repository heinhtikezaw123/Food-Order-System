                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropdown " style="margin-right: 80px">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark">
                                    <li><a href="{{ route('user#accountChangePage') }}" class="dropdown-item my-3"><i class="fa-solid fa-user me-2"></i>Account</a></li>
                                    <li><a href="{{ route('user#changePasswordPage') }}" class="dropdown-item my-3"><i class="fa-solid fa-key me-2"></i>Change Password</a></li>
                                    <li>
